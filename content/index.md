...
- [[content/1 introduction/index|1 Introduction]]
...
You can add more pages to your website by adding more Markdown files to the `content/` folder. Take a look at [[About new docs]] to learn more.
